...
const IntegrationConnectedCard = ({ service, onManage }: IntegrationConnectedCardProps) => {
	...
	return (
		<article
			className='flex flex-col overflow-hidden rounded-brand-md border border-neutral-200 bg-neutral-white shadow-sm transition-shadow hover:shadow-md'
		...
		>
			...
			<div className='mt-3 flex items-center justify-between border-t border-neutral-100 px-4 py-3'>
				...
				<div className='flex flex-col gap-0.5 text-right'>
					<span className='typo-caption1_regular text-neutral-400'>마지막 동기화</span>
					<span className='typo-body3_medium text-neutral-600'>{service.lastSync ?? '–'}</span>
				</div>
			</div>
			...
			<button
				type='button'
				onClick={onManage}
				className='mx-4 mb-4 inline-flex h-9 items-center justify-center gap-1 rounded-brand-sm border border-neutral-200 bg-neutral-white typo-body3_semibold text-neutral-700 transition-colors hover:border-main-blue hover:text-main-blue'
			>
				관리
