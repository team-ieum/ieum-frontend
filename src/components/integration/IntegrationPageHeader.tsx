...
const IntegrationPageHeader = () => (
	...
	>
		...
		<div className='flex shrink-0 items-center gap-2'>
			...
			<button
				type='button'
				className='inline-flex h-9 shrink-0 items-center gap-1.5 rounded-brand-sm bg-main-blue px-4 typo-body3_semibold text-neutral-white transition-colors hover:bg-main-deep-blue'
			>
				<Plus size={16} />새 연결
			</button>
		</div>
